...
(defun jag/agent-vterm-start-or-switch-opencode ()
  "Start or switch to the current workspace's OpenCode vterm agent."
  (interactive)
  (jag/agent-vterm-start-or-switch "opencode"))

(defun jag/agent-vterm-choose ()
  "Choose a vterm agent to start or switch in the current workspace."
  (interactive)
  (jag/agent-vterm-start-or-switch
...
(map! :leader
      ...
      "j a e" nil
      "j a q" nil
      :desc "Agent Claude" "j a c" #'jag/agent-vterm-start-or-switch-claude
      :desc "Agent OpenCode" "j a o" #'jag/agent-vterm-start-or-switch-opencode
      :desc "Agent Pi" "j a p" #'jag/agent-vterm-start-or-switch-pi
      :desc "Agent Codex" "j a x" #'jag/agent-vterm-start-or-switch-codex
