...
- Ships a guided `install-voyager` script on PATH that:
  1. Shows detected disks and asks the user to confirm the target device
     (confirm-the-disk prompt; no silent auto-wipe).
  ...
  4. Prints a done message and offers to reboot.
