...
(defun jag/agent-vterm-send-region (&optional start end)
...
(defun jag/agent-vterm-send-region-and-submit (&optional start end)
...
(map! :leader
      :desc "Legacy agent-shell" "j a a" #'agent-shell
      :desc "Legacy agent-shell compose prompt" "j a e" #'jag/agent-shell-prompt-compose-bottom
      "j a q" nil
      ...
      :desc "Send region to agent" "j a t" #'jag/agent-vterm-send-region)
#+end_src
