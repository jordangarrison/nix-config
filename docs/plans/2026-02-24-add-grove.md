...
**Architecture:** Add Grove as a flake input, destructure it in outputs, and reference the package in `home.nix` cross-platform packages list — same pattern as `aws-tools` and `aws-use-sso`.
